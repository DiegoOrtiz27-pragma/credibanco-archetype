package com.credibanco.swarch.dto;


import com.credibanco.swarch.exceptions.ApiErrorResponse;
...
public class ResponseFactory {
     ...
     */
    public ResponseEntity<ApiErrorResponse> createErrorResponse(Integer status, String message, String transactionId, ApiErrorResponse.ErrorDetails details) {
